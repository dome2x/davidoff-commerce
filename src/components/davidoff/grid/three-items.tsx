  ...
  return (
    <>
      <div className="relative w-screen overflow-hidden">
        <div
          ref={carouselRef}
          className="flex gap-5 overflow-x-hidden py-8 px-4"
          style={{ scrollSnapType: 'x mandatory' }}
        >
          {products.data && products.data.map((product: { id: number; title: string; handle: string; availableForSale: boolean; featuredImage: { url: string; }; description: string }) => (
            <div key={product.id} style={{ scrollSnapAlign: 'start' }}>
              <GridItemTile data={{
                  ...
                  href: `/${lang}}/${country}/product/${product.handle}`,
                  featuredImage: {
        ...
        <Button
          ...
          disabled={carouselRef.current ? scrollPosition >= carouselRef.current.scrollWidth - carouselRef.current.clientWidth : undefined}
        >
